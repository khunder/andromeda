...
const DragHandler_1 = require("../src/designer/DragHandler");
const Renderer_1 = require("../src/designer/Renderer");
...
const renderer = new Renderer_1.Renderer(mockSVG);
// Create drag handler
const dragHandler = new DragHandler_1.DragHandler(elementManager, connectionManager, renderer, mockSVG, () => { });
...
console.log('Element 1 position:', element1 === null || element1 === void 0 ? void 0 : element1.x, element1 === null || element1 === void 0 ? void 0 : element1.y);
console.log('Element 2 position:', element2 === null || element2 === void 0 ? void 0 : element2.x, element2 === null || element2 === void 0 ? void 0 : element2.y);
// Test collision detection via private method access
// Note: In real usage, collision is handled internally during drag
if (element1 && element2) {
    const overlapping = (element1.x < element2.x + element2.width &&
